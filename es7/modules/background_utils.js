(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './tvs_exports.js', './math_utils.js'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./tvs_exports.js'), require('./math_utils.js'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.tvs_exports, global.math_utils);
        global.background_utils = mod.exports;
    }
})(this, function (exports, _tvs_exports, _math_utils) {
    'use strict';
    ...
    var myMath = _interopRequireWildcard(_math_utils);
