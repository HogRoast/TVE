(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        ...
        factory(mod.exports);
        global.content_utils = mod.exports;
    }
    ...
    function mutantMatch(mutation) {
        if (mutation.target.localName == 'tbody' && mutation.target.parentElement.className == 'alert-list'
    ...
    exports.correctTVDTS = correctTVDTS;
    exports.withinSeconds = withinSeconds;
    exports.extractOrder = extractOrder;
    exports.mutantMatch = mutantMatch;
});